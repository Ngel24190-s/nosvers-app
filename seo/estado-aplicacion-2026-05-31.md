...
## Vía real de aplicación
1. **WP REST API** (https://nosvers.com/wp-json/ responde 200) con application
   password — escribir meta AIOSEO por página (id home = 490).
2. **Manual** en WP-Admin → AIOSEO por página.

Textos propuestos: ver seo/propuesta-cambios-2026-05.md (sin cambios).
